...
post1 = Post.create(performance_type: "Concert", voice_type: "Mezzo-Soprano", time: Time.now, date: Date.new, repertoire: "Brahms Requiem", notes: "Must be an excellent sightreader.", venue_name: "Chicago Symphony Orchestra", street_address: "220 S Michigan Ave", city: "Chicago", state: "IL", zip: 60604, contact_first_name: lindsay.first_name, contact_last_name: lindsay.last_name, contact_email: lindsay.email, paid: true, user: lindsay)
post2 = Post.create(performance_type: "Religious Service", voice_type: "Mezzo-Soprano", time: Time.now, date: Date.new, repertoire: "Britten and Hovhaness", notes: "Must be an excellent sightreader. There is no rehearsal beforehand.", venue_name: "First United Methodist Church", street_address: "516 Church St", city: "Evanston", state: "IL", zip: 60201, contact_first_name: nicolette.first_name, contact_last_name: nicolette.last_name, contact_email: nicolette.email, paid: true, user: nicolette)
post3 = Post.create(performance_type: "Rehearsal", voice_type: "Countertenor", time: Time.now, date: Date.new, repertoire: "Bach Magnificat", notes: "I need a mezzo or alto to fill in for a rehearsal. Must know the Bach Magnificat alto solos.", venue_name: "St. John Cantius Church", street_address: "825 N Carpenter St", city: "Chicago", state: "IL", zip: 60642, contact_first_name: josh.first_name, contact_last_name: josh.last_name, contact_email: josh.email, paid: true, user: josh)
